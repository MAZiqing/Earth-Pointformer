...
# from earthformer.datasets.himawari.himawari_dataset import *
from earthformer.datasets.era5.era5_dataset import *
...
class CuboidMovingMNISTPLModule(pl.LightningModule):
    ...
    def get_movingmnist_datamodule(micro_batch_size: int = 1):
        ...
        # dm = HimawariDataModule(batch_size=micro_batch_size)
        dm = ERA5DataModule(batch_size=micro_batch_size)
        return dm
