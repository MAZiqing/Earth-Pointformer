...
class Model(nn.Module):
    ...
    def forward(self, x_enc): #, x_mark_enc, x_dec, x_mark_dec,
        ...
        x_divide2 = self.attn_divide2(x_divide2, x_divide2, x_divide2) + x_divide2
        x_divide4 = self.downsample_divide4(x_divide2)

        x_divide4 = self.attn_divide4(x_divide4, x_divide4, x_divide4) + x_divide4
        ...
        x_dec_divide2 = self.attn_dec_divide2(x_dec_divide2, x_divide2, x_divide2) + x_dec_divide2
