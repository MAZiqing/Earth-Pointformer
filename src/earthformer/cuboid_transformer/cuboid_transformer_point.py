...
try:
    ...
    from src.earthformer.cuboid_transformer.cuboid_transformer_patterns import CuboidSelfAttentionPatterns, CuboidCrossAttentionPatterns
    from src.earthformer.cuboid_transformer.utils import (
    get_activation, get_norm_layer,
    _generalize_padding, _generalize_unpadding,
    apply_initialization, round_to)
...
if __name__ == '__main__':
    ...
    model = CuboidTransformerModel(input_shape=input_shape, target_shape=output_shape)
